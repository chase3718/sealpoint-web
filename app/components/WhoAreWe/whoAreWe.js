			...
			<div className={styles.wrapperText}>
				<div className={styles.text}>
					...
					<p>
						...
						powerful instrumentals, and intense stage presence. The band draws inspiration from bands such as Taking
						Back Sunday, Dance Gavin Dance, and Deftones to create their signature sound that combines elements of
